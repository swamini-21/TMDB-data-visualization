...
fig_line = px.line(movies_per_decade, x='Decade', y='Number of Movies', title="Movies Released per Decade")
...
# df = pd.read_csv("clean_new.csv")
# For demo, assume df_expl is prepared
# df_expl = (df.assign(keywords=df['keywords'].str.split(r' \| ')).explode('keywords'))

# Here, provide df_expl from your clean data
# -------------------------------------------------------------------
# Example placeholder:
# df_expl = pd.DataFrame({
#     'genres': ['Action', 'Action', 'Drama'],
#     'keywords': ['fight','battle','tears']
# })
# -------------------------------------------------------------------
